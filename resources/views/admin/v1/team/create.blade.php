...
@section('content')
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('team.store')}}" id="team_form">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div>
                                ...
                                <input type="text" class="form-control" id="team_code" name="team_code" value="{{old('team_code') ?? ''}}">
                                @error('team_code')
                                    <span class="help-block input-error">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div>
                                ...
                                <input type="text" class="form-control" id="team_name" name="team_name" value="{{old('team_name') ?? ''}}">
                                @error('team_name')
                                    <span class="help-block input-error">{{ $message }}</span>
                                @enderror
                            </div>
